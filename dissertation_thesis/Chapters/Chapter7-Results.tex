...
While the \emph{CNV} network could not be deployed, it could still be trained and the results can be seen on \emph{Figure} \ref{fig:CNVErrorRate}. As in the \emph{TFdC} figure, the configurations are named A\emph{X}W\emph{X}, where \emph{X} is the bitwidth.
...
\begin{table}[!htb]
  ...
  \begin{tabular}{ | c | c | c | c | c | }
    ...
    \hline
    \textbf{A2W2}          & 2.140 [W]  & 30618 & 27704 \\
    \hline
    \textbf{A4W4}          & 2.151 [W]  & 30644 & 27760 \\
    \hline
    \textbf{A8W8}          & 2.070 [W]  & 30617 & 27660 \\
    \hline
    \textbf{A16W16}       & 2.136 [W]  & 30610 & 27717 \\
    \hline
    \textbf{A32W32}       & 2.159 [W]  & 30586 & 27670 \\
    \hline
  \end{tabular}
  }
